...
var _classList = function _classList(method, cn, dom) {
  ...
  isArray(cn) ? (_dom$classList = dom.classList)[method].apply(_dom$classList, toConsumableArray(cn)) : dom.classList[method](cn);
  return dom;
};
...
var _dom = function _dom(cs) {
  ...
  return isElmNode(root) ? root.querySelector(cs) : document.querySelector(cs);
};
...
var _domAll = function _domAll(cs) {
  ...
  var dom = isElmNode(root) ? root.querySelectorAll(cs) : document.querySelectorAll(cs);
