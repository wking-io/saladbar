...
test('hasData returns true when data attribute exists and value matches on an element', assert => {
...
test('hasData returns false when data attribute exists and value does not match on an element', assert => {
  const document = createElement(1, {
    attrs: ['data-test="true"'],
    classes: 'default',
  });
