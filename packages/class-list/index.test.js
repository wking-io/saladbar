...
test('classList adds a class to an element', assert => {
...
test('classList adds a class to a future element', assert => {
...
test('classList adds a class to multiple future elements', assert => {
  const futureEls = of([
    createElement({ classes: ['default'] }),
    createElement({ classes: ['default'] }),
    createElement({ classes: ['default'] }),
...
test('classList removes a class from an element', assert => {
...
test('classList removes a class from a future element', assert => {
...
test('classList removes a class from multiple future elements', assert => {
  const futureEls = of([
    createElement({ classes: ['default', 'remove-class'] }),
    createElement({ classes: ['default', 'remove-class'] }),
    createElement({ classes: ['default', 'remove-class'] }),
