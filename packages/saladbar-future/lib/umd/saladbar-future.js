(function(global, factory) {
  ...
  var _isArrayLike = /*#__PURE__*/ _curry1_1((x) => {
    if (_isArray(x)) {
      return true;
    }
    if (!x) {
  ...
  var bind = /*#__PURE__*/ _curry2_1((fn, thisObj) => {
  ...
  var _flatCat = function _xcat(xf) {
    ...
    return {
      ...
      '@@transducer/step': function(result, input) {
        return !_isArrayLike_1(input)
          ? _reduce_1(rxf, result, [input])
          : _reduce_1(rxf, result, input);
      },
    };
  };
  ...
  var _xmap = /*#__PURE__*/ _curry2_1((f, xf) => {
  ...
  var map = /*#__PURE__*/ _curry2_1(
    /*#__PURE__*/ _dispatchable_1(
  ...
  var _xchain = /*#__PURE__*/ _curry2_1((f, xf) => {
  ...
  var slice = /*#__PURE__*/ _curry3_1(
    /*#__PURE__*/ _checkForMethod_1('slice', (
      fromIndex,
      toIndex,
      list
    ) => {
  ...
  var tail = /*#__PURE__*/ _curry1_1(
    /*#__PURE__*/ _checkForMethod_1('tail', /*#__PURE__*/ slice_1(1, Infinity))
  );
  var tail_1 = tail;
  ...
  var reverse = /*#__PURE__*/ _curry1_1((list) => {
  ...
  var _xall = /*#__PURE__*/ _curry2_1((f, xf) => {
  ...
  var all = /*#__PURE__*/ _curry2_1(
    /*#__PURE__*/ _dispatchable_1(['all'], _xall_1, (fn, list) => {
      var idx = 0;
      while (idx < list.length) {
        if (!fn(list[idx])) {
          return false;
  ...
  var sanctuaryTypeIdentifiers = createCommonjsModule((module) => {
    /*
        @@@@@@@            @@@@@@@         @@
      @@       @@        @@       @@      @@@
    @@   @@@ @@  @@    @@   @@@ @@  @@   @@@@@@ @@   @@@  @@ @@@      @@@@
  ...
  var sanctuaryTypeClasses = createCommonjsModule((module) => {
    /*
             ############                  #
            ############                  ###
                  #####                  #####
  ...
  var inspectF = createCommonjsModule((module) => {
    (function(f) {
      /*istanbul ignore next*/
  ...
  var concurrify = createCommonjsModule((module) => {
    (function(f) {
      /*istanbul ignore next*/
      ...
      return function concurrify(Repr, zero, alt, ap) {
        ...
        var proto = (Concurrently.prototype = construct.prototype = {
  ...
  var fluture = createCommonjsModule((module, exports) => {
    (function(global, factory) {
  ...
  var guaranteeDomEl = function guaranteeDomEl(el) {
    if (isArray(el)) {
      return ifElse_1(all_1(isElmNode), fluture_2, () => {
        return fluture_3({
          error:
    ...
    return ifElse_1(isElmNode, fluture_2, () => {
      return fluture_3({
 ...
 */
  ...
  var _dom$1 = function _dom$$1(cs) {
    var root =
      arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    return fluture_4((rej, res) => {
      var elm = _dom(cs, root);
      return elm
        ? res(elm)
        : rej({
            error:
              'An element with the following selector was not found: ' + cs,
          });
    });
  };
  ...
  var ap = /*#__PURE__*/ _curry2_1((applyF, applyX) => {
  ...
  var prepend = /*#__PURE__*/ _curry2_1((el, list) => {
  ...
  var reduceRight = /*#__PURE__*/ _curry3_1((
    fn,
    acc,
    list
  ) => {
  ...
  var sequence = /*#__PURE__*/ _curry2_1((of, traversable) => {
  ...
  var futureFindParent = curry_1((global, pred, dom) => {
    var doc = global ? global : window.document;
    ...
    return pred(dom.parentElement).chain((res) => {
      return res
        ? fluture_2(dom.parentElement)
  ...
  var _findParent$1 = function _findParent(global, pred, dom) {
    return fluture_1(pred(dom))
      ? futureFindParent(global, pred, dom)
      : fluture_2(findParent(global, pred, dom));
  };
  ...
  var _setData$1 = function _setData(prop, val, dom) {
    ...
    return result
      ...
      : fluture_3({
          error:
            'The following data attribute you passed in is not valid: ' + prop,
        });
  };
