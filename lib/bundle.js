/**
 * Salad-bar bundled; version 0.0.2
 */
...
const saladbar = (function() {
   ...
   *      t(); //=> 'Tee'
   */
  const always = /* #__PURE__*/ _curry1((val) => function() {
      return val;
    });
   ...
   *      R.add(7)(10);      //=> 17
   */
  const add = /* #__PURE__*/ _curry2((a, b) => Number(a) + Number(b));
   ...
   *      g(4); //=> 10
   */
  const curryN = /* #__PURE__*/ _curry2((length, fn) => {
    if (length === 1) {
      return _curry1(fn);
    }
   ...
   *      R.max('a', 'b'); //=> 'b'
   */
  const max = /* #__PURE__*/ _curry2((a, b) => b > a ? b : a);
   ...
   */
  const _isArrayLike = /* #__PURE__*/ _curry1((x) => {
    if (_isArray(x)) {
      return true;
    }
    if (!x) {
   ...
   */
  const bind = /* #__PURE__*/ _curry2((fn, thisObj) => _arity(fn.length, function() {
  ...
  const _xmap = /* #__PURE__*/ _curry2((f, xf) => new XMap(f, xf));
  ...
  const hasEnumBug = !/* #__PURE__*/ { toString: null }.propertyIsEnumerable(
    'toString'
  );
  ...
  // Safari bug
  const hasArgsEnumBug = /* #__PURE__*/ (function() {
  ...
  const keys = /* #__PURE__*/ _curry1(_keys);
   ...
   */
  const path = /* #__PURE__*/ _curry2((paths, obj) => {
    let val = obj;
    let idx = 0;
  ...
  const prop = /* #__PURE__*/ _curry2((p, obj) => path([p], obj));
   ...
   */
  const pluck = /* #__PURE__*/ _curry2((p, list) => map(prop(p), list));
   ...
   */
  const reduce = /* #__PURE__*/ _curry3(_reduce);
   ...
   */
  const ap = /* #__PURE__*/ _curry2((applyF, applyX) => typeof applyX['fantasy-land/ap'] === 'function'
      ...
      : typeof applyF.ap === 'function'
        ...
        : typeof applyF === 'function'
          ...
          : // Else
            _reduce(
              (acc, f) => _concat(acc, map(f, applyX)),
              [],
              applyF
            ));
   ...
   */
  const liftN = /* #__PURE__*/ _curry2((arity, fn) => {
   ...
   */
  const lift = /* #__PURE__*/ _curry1((fn) => liftN(fn.length, fn));
   ...
   *      g(4); //=> 10
   */
  const curry = /* #__PURE__*/ _curry1((fn) => curryN(fn.length, fn));
   ...
   */
  const call = /* #__PURE__*/ curry(function call(fn) {
  ...
  const preservingReduced = function(xf) {
    return {
      ...
      '@@transducer/step'(result, input) {
        const ret = xf['@@transducer/step'](result, input);
        return ret['@@transducer/reduced'] ? _forceReduced(ret) : ret;
      },
    };
  };

  const _flatCat = function _xcat(xf) {
    const rxf = preservingReduced(xf);
    return {
      '@@transducer/init': _xfBase.init,
      '@@transducer/result'(result) {
  ...
  const _xchain = /* #__PURE__*/ _curry2((f, xf) => map(f, _flatCat(xf)));
   ...
   */
  const type = /* #__PURE__*/ _curry1((val) => val === null
      ? 'Null'
      : val === undefined
        ? 'Undefined'
   ...
   *      R.not(1); //=> false
   */
  const not = /* #__PURE__*/ _curry1((a) => !a);
   ...
   *      isNotNil(7); //=> true
   */
  const complement = /* #__PURE__*/ lift(not);
  ...
  function _checkForMethod(methodname, fn) {
    return function() {
      ...
      return _isArray(obj) || typeof obj[methodname] !== 'function'
        ...
        : obj[methodname](...Array.prototype.slice.call(arguments, 0, length - 1));
    };
  }
   ...
   */
  const slice = /* #__PURE__*/ _curry3(
    /* #__PURE__*/ _checkForMethod('slice', (
      fromIndex,
      toIndex,
      list
   ...
   *      R.reverse('');         //=> ''
   */
  const reverse = /* #__PURE__*/ _curry1((list) => _isString(list)
      ? list
          .split('')
          .reverse()
          .join('')
   ...
   */
  const identical = /* #__PURE__*/ _curry2((a, b) => {
    // SameValue algorithm
    if (a === b) {
      /*
       * Steps 1-5, 7-10
  ...
  function _uniqContentEquals(aIterator, bIterator, stackA, stackB) {
    ...
    return !_containsWith(
      (b, aItem) => !_containsWith(eq, aItem, b),
      b,
      a
    );
  }
   ...
   *      R.equals(a, b); //=> true
   */
  const equals = /* #__PURE__*/ _curry2((a, b) => _equals(a, b, [], []));
  ...
  const XFilter = /* #__PURE__*/ (function() {
  ...
  const _xfilter = /* #__PURE__*/ _curry2((f, xf) => new XFilter(f, xf));
   ...
   */
  const filter = /* #__PURE__*/ _curry2(
    /* #__PURE__*/ _dispatchable(['filter'], _xfilter, (
      pred,
      filterable
   ...
   */
  const reject = /* #__PURE__*/ _curry2((pred, filterable) => filter(_complement(pred), filterable));
  ...
  function _toString(x, seen) {
    ...
    const mapPairs = function(obj, keys$$1) {
      return _map((k) => `${_quote(k)  }: ${  recur(obj[k])}`, keys$$1.slice().sort());
    };
   ...
   */
  const toString$1 = /* #__PURE__*/ _curry1((val) => _toString(val, []));
   ...
   */
  const converge = /* #__PURE__*/ _curry2((after, fns) => curryN(reduce(max, 0, pluck('length', fns)), function() {
      const args = arguments;
      const context = this;
      return after.apply(
        context,
        _map((fn) => fn.apply(context, args), fns)
      );
    }));

  const XReduceBy = /* #__PURE__*/ (function() {
  ...
  const _xreduceBy = /* #__PURE__*/ _curryN(4, [], (
    valueFn,
    valueAcc,
    keyFn,
    xf
  ) => new XReduceBy(valueFn, valueAcc, keyFn, xf));
   ...
   *      // }
   */
  const reduceBy = /* #__PURE__*/ _curryN(
    4,
    [],
    /* #__PURE__*/ _dispatchable([], _xreduceBy, (
      valueFn,
      valueAcc,
      keyFn,
      list
   ...
   */
  const countBy = /* #__PURE__*/ reduceBy((acc, elem) => acc + 1, 0);
   ...
   *      R.dec(42); //=> 41
   */
  const dec = /* #__PURE__*/ add(-1);

  const XDropRepeatsWith = /* #__PURE__*/ (function() {
  ...
  const _xdropRepeatsWith = /* #__PURE__*/ _curry2((
    pred,
    xf
  ) => new XDropRepeatsWith(pred, xf));
   ...
   */
  const nth = /* #__PURE__*/ _curry2((offset, list) => {
   ...
   */
  const dropRepeatsWith = /* #__PURE__*/ _curry2(
    /* #__PURE__*/ _dispatchable([], _xdropRepeatsWith, (
      pred,
      list
    ) => {
      const result = [];
   ...
   */
  const dropRepeats = /* #__PURE__*/ _curry1(
    /* #__PURE__*/ _dispatchable(
      [],
   ...
   */
  const flip = /* #__PURE__*/ _curry1((fn) => curryN(fn.length, function(a, b) {
      const args = Array.prototype.slice.call(arguments, 0);
      args[0] = b;
      args[1] = a;
   ...
   *      // }
   */
  const groupBy = /* #__PURE__*/ _curry2(
    /* #__PURE__*/ _checkForMethod(
      'groupBy',
      /* #__PURE__*/ reduceBy((acc, item) => {
        if (acc == null) {
          acc = [];
        }
        acc.push(item);
   ...
   * @symb R.identity(a) = a
   */
  const identity = /* #__PURE__*/ _curry1(_identity);
   ...
   */
  const indexBy = /* #__PURE__*/ reduceBy((acc, elem) => elem, null);
   ...
   *      R.init('');     //=> ''
   */
  const init = /* #__PURE__*/ slice(0, -1);

  const _Set = /* #__PURE__*/ (function() {
    function _Set() {
      /* globals Set */
   ...
   */
  const uniqBy = /* #__PURE__*/ _curry2((fn, list) => {
    const set = new _Set();
    const result = [];
    let idx = 0;
   ...
   *      R.uniq([[42], [42]]); //=> [[42]]
   */
  const uniq = /* #__PURE__*/ uniqBy(identity);
   ...
   */
  const invoker = /* #__PURE__*/ _curry2((arity, method) => curryN(arity + 1, function() {
      const target = arguments[arity];
      if (target != null && _isFunction(target[method])) {
        return target[method](...Array.prototype.slice.call(arguments, 0, arity));
      }
      throw new TypeError(
   ...
   *      R.join('|', [1, 2, 3]);    //=> '1|2|3'
   */
  const join = /* #__PURE__*/ invoker(1, 'join');
   ...
   */
  const juxt = /* #__PURE__*/ _curry1((fns) => converge(function() {
   ...
   */
  const sum = /* #__PURE__*/ reduce(add, 0);
   ...
   *      count; //=> 1
   */
  const memoizeWith = /* #__PURE__*/ _curry2((mFn, fn) => {
    const cache = {};
   ...
   *      count; //=> 1
   */
  const memoize = /* #__PURE__*/ memoizeWith(function() {
   ...
   *      R.multiply(2, 5);  //=> 10
   */
  const multiply = /* #__PURE__*/ _curry2((a, b) => a * b);

  function _createPartialApplicator(concat) {
    return _curry2((fn, args) => _arity(Math.max(0, fn.length - args.length), function() {
   ...
   */
  const partialRight = /* #__PURE__*/ _createPartialApplicator(
   ...
   */
  const partition = /* #__PURE__*/ juxt([filter, reject]);
   ...
   */
  const pickAll = /* #__PURE__*/ _curry2((names, obj) => {
    const result = {};
    let idx = 0;
   ...
   */
  const prepend = /* #__PURE__*/ _curry2((el, list) => _concat([el], list));
   ...
   */
  const product = /* #__PURE__*/ reduce(multiply, 1);
   ...
   */
  const useWith = /* #__PURE__*/ _curry2((fn, transformers) => curryN(transformers.length, function() {
      const args = [];
      let idx = 0;
   ...
   */
  const project = /* #__PURE__*/ useWith(_map, [pickAll, identity]); // Passing `identity` gives correct arity
   ...
   */
  const reduceRight = /* #__PURE__*/ _curry3((fn, acc, list) => {
   ...
   */
  const sequence = /* #__PURE__*/ _curry2((of, traversable) => typeof traversable.sequence === 'function'
   ...
   */
  const split = /* #__PURE__*/ invoker(1, 'split');
   ...
   *      R.toLower('XYZ'); //=> 'xyz'
   */
  const toLower = /* #__PURE__*/ invoker(0, 'toLowerCase');
   ...
   *      R.toUpper('abc'); //=> 'ABC'
   */
  const toUpper = /* #__PURE__*/ invoker(0, 'toUpperCase');
   ...
   */
  const transduce = /* #__PURE__*/ curryN(4, (
    xf,
    fn,
    acc,
    list
  ) => _reduce(xf(typeof fn === 'function' ? _xwrap(fn) : fn), acc, list));
   ...
   */
  const traverse = /* #__PURE__*/ _curry3((of, f, traversable) => typeof traversable['fantasy-land/traverse'] === 'function'
   ...
   */
  const _trim =
    !hasProtoTrim || /* #__PURE__*/ ws.trim() || !/* #__PURE__*/ zeroWidth.trim()
      ? function trim(str) {
   ...
   */
  const union = /* #__PURE__*/ _curry2(/* #__PURE__*/ compose(uniq, _concat));
   ...
   */
  const unnest = /* #__PURE__*/ chain(_identity);
  ...
  const sanctuaryTypeIdentifiers = createCommonjsModule((module) => {
    /*
     * @@@@@@@            @@@@@@@         @@
     * @@       @@        @@       @@      @@@
     * @@   @@@ @@  @@    @@   @@@ @@  @@   @@@@@@ @@   @@@  @@ @@@      @@@@
  ...
  const sanctuaryTypeClasses = createCommonjsModule((module) => {
    /*
     * ############                  #
     * ############                  ###
     * #####                  #####
    ...
    (function(f) {
      ...
      function TypeClass(name, url, dependencies, test) {
        ...
        this.test = function(x) {
          return (
            dependencies.every((d) => d.test(x)) && test(x)
          );
        };
      }
      ...
      function $(_name, dependencies, requirements) {
        ...
        const version = '8.0.0'; // Updated programmatically
        ...
        const typeClass = TypeClass(
          ...
          dependencies,
          (x) => keys.every((_name) => {
              const arg = requirements[_name] === Constructor ? x.constructor : x;
              return getBoundMethod(_name)(arg) != null;
            })
        );

        typeClass.methods = keys.reduce((methods, _name) => {
       ...
       *. ```
       */
      const Setoid = $('Setoid', [], { equals: Value });
       ...
       *. ```
       */
      const Ord = $('Ord', [Setoid], { lte: Value });
       ...
       *. ```
       */
      const Semigroupoid = $('Semigroupoid', [], { compose: Value });
       ...
       *. ```
       */
      const Category = $('Category', [Semigroupoid], { id: Constructor });
       ...
       *. ```
       */
      const Semigroup = $('Semigroup', [], { concat: Value });
       ...
       *. ```
       */
      const Monoid = $('Monoid', [Semigroup], { empty: Constructor });
       ...
       *. ```
       */
      const Group = $('Group', [Monoid], { invert: Value });
       ...
       *. ```
       */
      const Filterable = $('Filterable', [], { filter: Value });
       ...
       *. ```
       */
      const Functor = $('Functor', [], { map: Value });
       ...
       *. ```
       */
      const Bifunctor = $('Bifunctor', [Functor], { bimap: Value });
       ...
       *. ```
       */
      const Profunctor = $('Profunctor', [Functor], { promap: Value });
       ...
       *. ```
       */
      const Apply = $('Apply', [Functor], { ap: Value });
       ...
       *. ```
       */
      const Applicative = $('Applicative', [Apply], { of: Constructor });
       ...
       *. ```
       */
      const Chain = $('Chain', [Apply], { chain: Value });
       ...
       *. ```
       */
      const ChainRec = $('ChainRec', [Chain], { chainRec: Constructor });
       ...
       *. ```
       */
      const Monad = $('Monad', [Applicative, Chain], {});
       ...
       *. ```
       */
      const Alt = $('Alt', [Functor], { alt: Value });
       ...
       *. ```
       */
      const Plus = $('Plus', [Alt], { zero: Constructor });
       ...
       *. ```
       */
      const Alternative = $('Alternative', [Applicative, Plus], {});
       ...
       *. ```
       */
      const Foldable = $('Foldable', [], { reduce: Value });
       ...
       *. ```
       */
      const Traversable = $('Traversable', [Functor, Foldable], {
        traverse: Value,
      });
       ...
       *. ```
       */
      const Extend = $('Extend', [Functor], { extend: Value });
       ...
       *. ```
       */
      const Comonad = $('Comonad', [Extend], { extract: Value });
       ...
       *. ```
       */
      const Contravariant = $('Contravariant', [], { contramap: Value });
      ...
      function Date$prototype$toString() {
        const x = isNaN(this.valueOf()) ? NaN : this.toISOString();
      ...
      function Array$chainRec(f, x) {
        ...
        const $done = [];
        while ($todo.length > 0) {
          const xs = f(iterationNext, iterationDone, $todo.shift());
          const $more = [];
      ...
      function Array$prototype$reduce(f, initial) {
        return this.reduce((acc, x) => f(acc, x), initial);
      }
      ...
      function Arguments$prototype$toString() {
        const args = Array.prototype.map.call(this, toString).join(', ');
      ...
      function Error$prototype$equals(other) {
        return (
          equals(this.name, other.name) && equals(this.message, other.message)
        );
      }
      ...
      function Object$prototype$equals(other) {
        ...
        return (
          ...
          keys.every((k) => equals(self[k], other[k]))
        );
      }
      ...
      function Object$prototype$traverse(typeRep, f) {
        const self = this;
        return Object.keys(this).reduce((applicative, k) => {
          function set(o) {
            return function(v) {
              const singleton = {};
              singleton[k] = v;
      ...
      function Function$prototype$extend(f) {
        const extend = this;
        return function(x) {
          return f((y) => extend(concat(x, y)));
        };
      }

      //  Function$prototype$contramap :: (b -> c) ~> (a -> b) -> (a -> c)
      function Function$prototype$contramap(f) {
        const contravariant = this;
        return function(x) {
      ...
      var toString = (function() {
        ...
        return function toString(x) {
          ...
          return call(
            implPath([xType, 'prototype', 'toString']) || x.toString,
            x
          );
        };
      })();
      ...
      function reject(pred, filterable) {
        return filter((x) => !pred(x), filterable);
      }
        ...
        const rs = reduce(
          (xs, x) => {
            ...
            while (lower < upper) {
              ...
              if (lte(xs[idx].fx, fx)) lower = idx + 1;
              else upper = idx;
            }
            xs.splice(lower, 0, { x, fx });
            return xs;
          },
          [],
          foldable
      ...
      function takeWhile(pred, foldable) {
        let take = true;
        return filter((x) => (take = take && pred(x)), foldable);
      }
  ...
  const inspectF = createCommonjsModule((module) => {
    (function(f) {
      {
        module.exports = f();
      }
      ...
      function fixIndentation(lines, indentation) {
        ...
        return lines
          .map((line) => line
              .slice(Math.min(info.depth, getPadding(line)))
              .replace(RPAD, '\t')
              .replace(RTABS, indentation))
          .join('\n');
      }
  ...
  const sanctuaryTypeIdentifiers$2 = createCommonjsModule((module) => {
    /*
     * @@@@@@@            @@@@@@@         @@
     * @@       @@        @@       @@      @@@
     * @@   @@@ @@  @@    @@   @@@ @@  @@   @@@@@@ @@   @@@  @@ @@@      @@@@
  ...
  const concurrify = createCommonjsModule((module) => {
    (function(f) {
      {
      ...
      function generateTypeIdentifier(identifier) {
        const o = type.parse(identifier);
        return (
          `${o.namespace || 'concurrify' 
          }/Concurrent${ 
          o.name 
          }@${ 
          o.version}`
      ...
      return function concurrify(Repr, zero, alt, ap) {
        const INNERTYPE = getTypeIdentifier(Repr);
        const OUTERTYPE = generateTypeIdentifier(INNERTYPE);
        const INNERNAME = type.parse(INNERTYPE).name;
        const OUTERNAME = type.parse(OUTERTYPE).name;
        ...
        const proto = (Concurrently.prototype = construct.prototype = {
  ...
  const fluture = createCommonjsModule((module, exports) => {
    (function(global, factory) {
      module.exports = factory(
        sanctuaryTypeClasses,
        inspectF,
        sanctuaryTypeIdentifiers$2,
        concurrify,
        denque
      );
    })(commonjsGlobal, (Z, inspectf, type, concurrify$$1, Denque) => {
      Z = Z && Z.hasOwnProperty('default') ? Z.default : Z;
      inspectf =
        inspectf && inspectf.hasOwnProperty('default')
          ? inspectf.default
          : inspectf;
      type = type && type.hasOwnProperty('default') ? type.default : type;
      concurrify$$1 =
        concurrify$$1 && concurrify$$1.hasOwnProperty('default')
          ? concurrify$$1.default
          : concurrify$$1;
      Denque =
        Denque && Denque.hasOwnProperty('default') ? Denque.default : Denque;
      ...
      function invalidContext(it, actual) {
        typeError(
          `${it 
            } was invoked outside the context of a Future. You might want to use` +
      ...
      function invalidNamespace(m, x) {
        return (
          ...
          `Got ${ 
          x ? `a Future from ${  x}` : 'an unscoped Future' 
          }.` +
      ...
      function invalidFuture(it, at, m, s) {
          ...
          id.name === name
            ? `\n${ 
              id.namespace !== namespace
                ? invalidNamespace(m, id.namespace)
                : id.version !== version
                  ? invalidVersion(m, id.version)
        ...
        typeError(
          `${it 
            ...
            ordinal[at]
              ? `its ${  ordinal[at]  } argument to be a valid Future`
              : at 
            }.${ 
            info 
            }\n  Actual: ${ 
      ...
      const empty = { isEmpty: true, size: 0, head: null, tail: null };

      function cons(head, tail) {
        return { isEmpty: false, size: tail.size + 1, head, tail };
      }
      ...
      function Future(computation) {
        if (!isFunction(computation))
          invalidArgument('Future', 0, 'be a Function', computation);
      ...
      Future.prototype.map = function Future$map(mapper) {
        ...
        if (!isFunction(mapper))
          invalidArgument('Future#map', 0, 'to be a Function', mapper);
        return this._map(mapper);
      };

      Future.prototype.bimap = function Future$bimap(lmapper, rmapper) {
        if (!isFuture(this)) invalidContext('Future#bimap', this);
        if (!isFunction(lmapper))
          invalidArgument('Future#bimap', 0, 'to be a Function', lmapper);
        if (!isFunction(rmapper))
          invalidArgument('Future#bimap', 1, 'to be a Function', rmapper);
        return this._bimap(lmapper, rmapper);
      };
      ...
      Future.prototype.chain = function Future$chain(mapper) {
        ...
        if (!isFunction(mapper))
          invalidArgument('Future#chain', 0, 'to be a Function', mapper);
        return this._chain(mapper);
      };
      ...
      Future.prototype.mapRej = function Future$mapRej(mapper) {
        ...
        if (!isFunction(mapper))
          invalidArgument('Future#mapRej', 0, 'to be a Function', mapper);
      ...
      Future.prototype.chainRej = function Future$chainRej(mapper) {
        ...
        if (!isFunction(mapper))
          invalidArgument('Future#chainRej', 0, 'to be a Function', mapper);
      ...
      Future.prototype.fold = function Future$fold(lmapper, rmapper) {
        if (!isFuture(this)) invalidContext('Future#ap', this);
        if (!isFunction(lmapper))
          invalidArgument('Future#fold', 0, 'to be a Function', lmapper);
        if (!isFunction(rmapper))
          invalidArgument('Future#fold', 1, 'to be a Function', rmapper);
      ...
      Future.prototype.fork = function Future$fork(rej, res) {
        ...
        if (!isFunction(rej))
          invalidArgument('Future#fork', 0, 'to be a Function', rej);
        if (!isFunction(res))
          invalidArgument('Future#fork', 0, 'to be a Function', res);
      ...
      Future.prototype.value = function Future$value(res) {
        ...
        if (!isFunction(res))
          invalidArgument('Future#value', 0, 'to be a Function', res);
      ...
      Future.prototype.done = function Future$done(callback) {
        ...
        if (!isFunction(callback))
          invalidArgument('Future#done', 0, 'to be a Function', callback);
        return this._fork(
          (x) => {
            callback(x);
          },
      ...
      const Core = Object.create(Future.prototype);
      ...
      function check$fork(f, c) {
        if (!(f === undefined || (isFunction(f) && f.length === 0)))
          typeError(
      ...
      Resolved.prototype._both = function Resolved$both(other) {
        ...
        return other._map((right) => [left, right]);
      };
      ...
      BimapAction.prototype.toString = function BimapAction$toString() {
        return (
          `bimap(${  showf(this.lmapper)  }, ${  showf(this.rmapper)  })`
        );
      };
      ...
      ChainRec.prototype.toString = function ChainRec$toString() {
        return (
          `Future.chainRec(${  showf(this._step)  }, ${  show(this._init)  })`
        );
      };
      ...
      function ap$mval(mval, mfunc) {
        if (!Z.Apply.test(mfunc))
          invalidArgument('Future.ap', 1, 'be an Apply', mfunc);
        return Z.ap(mval, mfunc);
      }

      function ap(mval, mfunc) {
        if (!Z.Apply.test(mval))
          invalidArgument('Future.ap', 0, 'be an Apply', mval);
      ...
      function map$mapper(mapper, m) {
        if (!Z.Functor.test(m))
          invalidArgument('Future.map', 1, 'be a Functor', m);
        return Z.map(mapper, m);
      }

      function map(mapper, m) {
        if (!isFunction(mapper))
          invalidArgument('Future.map', 0, 'be a Function', mapper);
      ...
      function bimap$lmapper$rmapper(lmapper, rmapper, m) {
        if (!Z.Bifunctor.test(m))
          invalidArgument('Future.bimap', 2, 'be a Bifunctor', m);
        return Z.bimap(lmapper, rmapper, m);
      }

      function bimap$lmapper(lmapper, rmapper, m) {
        if (!isFunction(rmapper))
          invalidArgument('Future.bimap', 1, 'be a Function', rmapper);
        if (arguments.length === 2)
          return partial2(bimap$lmapper$rmapper, lmapper, rmapper);
        return bimap$lmapper$rmapper(lmapper, rmapper, m);
      }

      function bimap(lmapper, rmapper, m) {
        if (!isFunction(lmapper))
          invalidArgument('Future.bimap', 0, 'be a Function', lmapper);
      ...
      function chain$chainer(chainer, m) {
        if (!Z.Chain.test(m))
          invalidArgument('Future.chain', 1, 'be a Chain', m);
        return Z.chain(chainer, m);
      }

      function chain(chainer, m) {
        if (!isFunction(chainer))
          invalidArgument('Future.chain', 0, 'be a Function', chainer);
      ...
      function mapRej(mapper, m) {
        if (!isFunction(mapper))
          invalidArgument('Future.mapRej', 0, 'be a Function', mapper);
      ...
      function chainRej(chainer, m) {
        if (!isFunction(chainer))
          invalidArgument('Future.chainRej', 0, 'be a Function', chainer);
      ...
      function fold$f(f, g, m) {
        if (!isFunction(g))
          invalidArgument('Future.fold', 1, 'be a function', g);
      ...
      function fold(f, g, m) {
        if (!isFunction(f))
          invalidArgument('Future.fold', 0, 'be a function', f);
      ...
      function done(callback, m) {
        if (!isFunction(callback))
          invalidArgument('Future.done', 0, 'be a Function', callback);
      ...
      function fork$f(f, g, m) {
        if (!isFunction(g))
          invalidArgument('Future.fork', 1, 'be a function', g);
      ...
      function fork(f, g, m) {
        if (!isFunction(f))
          invalidArgument('Future.fork', 0, 'be a function', f);
      ...
      function value(cont, m) {
        if (!isFunction(cont))
          invalidArgument('Future.value', 0, 'be a Function', cont);
      ...
      ParallelAp.prototype._fork = function ParallelAp$fork(rej, res) {
        ...
        c1 = this._mval._fork(ParallelAp$rej, (
          x
        ) => {
          c1 = noop;
        ...
        c2 = this._mfunc._fork(ParallelAp$rej, (
          f
        ) => {
          c2 = noop;
          check$ap$f(f);
      ...
      After.prototype.toString = function After$toString() {
        return (
          `Future.after(${  show(this._time)  }, ${  show(this._value)  })`
        );
      };
      ...
      function after(time, value) {
        if (!isUnsigned(time))
          invalidArgument('Future.after', 0, 'be a positive integer', time);
      ...
      function attempt(f) {
        if (!isFunction(f))
          invalidArgument('Future.try', 0, 'be a function', f);
        return new Attempt(f);
      }

      const Cold = (Cached.Cold = 0);
      const Pending = (Cached.Pending = 1);
      const Rejected$1 = (Cached.Rejected = 2);
      const Resolved$1 = (Cached.Resolved = 3);
      ...
      Cached.prototype._fork = function Cached$_fork(rej, res) {
        ...
        switch (this._state) {
          case Pending:
            cancel = this._addToQueue(rej, res);
            break;
          case Rejected$1:
            rej(this._value);
            break;
      ...
      function encase(f, x) {
        if (!isFunction(f))
          invalidArgument('Future.encase', 0, 'be a function', f);
      ...
      function encase2(f, x, y) {
        if (!isFunction(f))
          invalidArgument('Future.encase2', 0, 'be a function', f);
      ...
      function encase3(f, x, y, z) {
        if (!isFunction(f))
          invalidArgument('Future.encase3', 0, 'be a function', f);
      ...
      function encaseN(f, x) {
        if (!isFunction(f))
          invalidArgument('Future.encaseN', 0, 'be a function', f);
      ...
      EncaseN2.prototype._fork = function EncaseN2$fork(rej, res) {
        let open = true;
        this._fn(this._a, this._b, (err, val) => {
          if (open) {
            open = false;
            err ? rej(err) : res(val);
          }
      ...
      function encaseN2(f, x, y) {
        if (!isFunction(f))
          invalidArgument('Future.encaseN2', 0, 'be a function', f);
      ...
      EncaseN$1.prototype._fork = function EncaseN$3$fork(rej, res) {
        let open = true;
        this._fn(this._a, this._b, this._c, (err, val) => {
          if (open) {
            open = false;
            err ? rej(err) : res(val);
          }
      ...
      function encaseN3(f, x, y, z) {
        if (!isFunction(f))
          invalidArgument('Future.encaseN3', 0, 'be a function', f);
      ...
      EncaseP.prototype._fork = function EncaseP$fork(rej, res) {
        ...
        const _a = this._a;
        let open = true;
        check$promise(_fn(_a), _fn, _a).then(
          immediately((x) => {
            if (open) {
              open = false;
              res(x);
      ...
      function encaseP(f, x) {
        if (!isFunction(f))
          invalidArgument('Future.encaseP', 0, 'be a function', f);
      ...
      EncaseP2.prototype._fork = function EncaseP2$fork(rej, res) {
        ...
        const _b = this._b;
        let open = true;
        check$promise$1(_fn(_a, _b), _fn, _a, _b).then(
          immediately((x) => {
            if (open) {
              open = false;
              res(x);
      ...
      function encaseP2(f, x, y) {
        if (!isFunction(f))
          invalidArgument('Future.encaseP2', 0, 'be a function', f);
      ...
      EncaseP3.prototype._fork = function EncaseP3$fork(rej, res) {
        ...
        const _c = this._c;
        let open = true;
        check$promise$2(_fn(_a, _b, _c), _fn, _a, _b, _c).then(
          immediately((x) => {
            if (open) {
              open = false;
              res(x);
      ...
      function encaseP3(f, x, y, z) {
        if (!isFunction(f))
          invalidArgument('Future.encaseP3', 0, 'be a function', f);
      ...
      function go(generator) {
        if (!isFunction(generator))
          invalidArgument('Future.do', 0, 'be a Function', generator);
      ...
      function hook$acquire$cleanup(acquire, cleanup, consume) {
        if (!isFunction(consume))
          invalidArgument('Future.hook', 2, 'be a Future', consume);
        return new Hook(acquire, cleanup, consume);
      }

      function hook$acquire(acquire, cleanup, consume) {
        if (!isFunction(cleanup))
          invalidArgument('Future.hook', 1, 'be a function', cleanup);
        if (arguments.length === 2)
          return partial2(hook$acquire$cleanup, acquire, cleanup);
      ...
      function node(f) {
        if (!isFunction(f))
          invalidArgument('Future.node', 0, 'be a function', f);
        return new Node(f);
      }
      ...
      Parallel.prototype._fork = function Parallel$_fork(rej, res) {
        let _futures = this._futures,
          _length = this._length,
          _max = this._max;
        let cancels = new Array(_length),
        ...
        function Parallel$run(idx) {
          running++;
          cancels[idx] = _futures[idx]._fork(
            (reason) => {
              cancels[idx] = noop;
              Parallel$cancel();
              rej(reason);
      ...
      Parallel.prototype.toString = function Parallel$toString() {
        return (
          `Future.parallel(${  this._max  }, ${  show(this._futures)  })`
        );
      };
      ...
      function parallel$max(max, xs) {
        if (!isArray(xs))
          invalidArgument('Future.parallel', 1, 'be an array', xs);
      ...
      function parallel(max, xs) {
        if (!isUnsigned(max))
          invalidArgument('Future.parallel', 0, 'be a positive integer', max);
      ...
      TryP.prototype._fork = function TryP$fork(rej, res) {
        let open = true;
        check$promise$3(this._fn(), this._fn).then(
          immediately((x) => {
            if (open) {
              open = false;
              res(x);
      ...
      function tryP(f) {
        if (!isFunction(f))
          invalidArgument('Future.tryP', 0, 'be a function', f);
        return new TryP(f);
      }

      if (typeof Object.create !== 'function')
        error('Please polyfill Object.create to use Fluture');
      if (typeof Object.assign !== 'function')
        error('Please polyfill Object.assign to use Fluture');
      if (typeof Array.isArray !== 'function')
        error('Please polyfill Array.isArray to use Fluture');
      ...
      const Par = concurrify$$1(Future, never, race, parallelAp);
      Par.of = Par[FL.of];
      ...
      function seq(par) {
        if (!isParallel(par))
          invalidArgument('Future.seq', 0, 'to be a Par', par);
        return par.sequential;
      }

      const Fluture = Object.freeze({
        Future,
        default: Future,
        Par,
        isParallel,
      ...
      const index_cjs = Object.assign(Future, Fluture);

      return index_cjs;
    });
  });

  const fluture_1 = fluture.isFuture;
  const fluture_2 = fluture.of;
  const fluture_3 = fluture.reject;
  ...
  const _getAttr = curry((attr, el) => {
    if (el.hasAttribute(attr)) {
      return fluture_2(el.getAttribute(attr));
    }

    return fluture_3({ error: `Sorry, ${  attr  } was not found.` });
  });
   ...
   */
  const _hasProp = curry((prop, el) => fluture_2(prop in el));
  ...
  const _getAttr$2 = curry((prop, el) => {
    if (hasProp(prop, el)) {
      return fluture_2(el[prop]);
    }

    return fluture_3({ error: `Sorry, ${  prop  } was not found.` });
  });
  ...
  const _hasAttr = curry((attr, el) => fluture_2(el.hasAttribute(attr)));
   ...
   * @sig String -> DOM Element -> Future Bool
   */
  const _hasClass = curry((classname, el) => fluture_2(el.classList.contains(classname)));
