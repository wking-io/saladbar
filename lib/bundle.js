const saladbar = (function() {
  ...
  var Pt = Mt,
    ...
    Zt = Z((t, n, e) => e === n.body
        ? Nt(e)
        : zt(t(e.parentElement))
          ? et(
              J(
                dt(
                  _t,
                  () => Nt(e.parentElement),
                  () => Zt(t, n, e.parentElement)
                )
              ),
              t
            )(e.parentElement)
          : dt(t, Nt, Zt(t, n))(e.parentElement)),
    $t = Z((t, n) => n.hasAttribute(t)
        ? Nt(n.getAttribute(t))
    ...
    Ht = Z((t) => It(Yt)(t)),
    Kt = Z((t, n) => Nt(lt(t, n.dataset))),
    tn = Z((t, n) => It(Kt(t))(n)),
    nn = Z((t, n) => tn(t, n).chain((e) => e
          ? Nt(n.dataset[t])
          : Ct({ error: `Sorry, data-attribute ${  t  } was not found.` }))),
    en = Z((t, n) => It(nn(t))(n)),
    rn = Z((t, n) => Nt(t in n)),
    un = Z((t, n) => It(rn(t))(n)),
    on = Z((t, n) => un(t, n).chain((e) => e ? Nt(n[t]) : Ct({ error: `Sorry, ${  t  } was not found.` }))),
    an = Z((t, n) => It(on(t))(n)),
    cn = Z((t, n) => Nt(n.hasAttribute(t))),
    sn = Z((t, n) => It(cn(t))(n)),
    fn = Z((t, n) => Nt(n.classList.contains(t))),
    hn = Z((t, n) => It(fn(t))(n)),
    pn = Z((t, n) => n.removeAttribute(t), Nt(n)),
    ln = Z((t, n) => It(pn(t))(n)),
    yn = Qt('remove'),
    _n = Z((t, n) => {
      if (tn(t, n) && !delete n.dataset[t])
        return Ct({ error: `Property ${  t  } is non-configurable.` });
      return Nt(n);
    }),
    dn = Z((t, n) => It(_n(t))(n)),
    vn = G((t) => t.type !== 'submit', et(X(vt), C('name'))),
    mn = et(W, C('elements')),
    gn = T((t, n) => dt(vn, et(L(e, t), gt(['name', 'value'])), () => t)(n), []),
    bn = dt(
    ...
    Fn = Z((t, n, e) => e.setAttribute(t, n), Nt(e)),
    wn = Z((t, n, e) => It(Fn(t, n))(e)),
    jn = /^[a-zA-Z0-9]?[a-zA-Z0-9_:.]*[a-zA-Z0-9]$/,
    kn = Z((t, n, e) => (function(t) {
        const n = t.match(jn);
        return n && n.length === 1;
      })(t)
        ? ((e.dataset[t] = n), Nt(e))
        : Ct({ error: `Data property ${  t  } is not a valid property name` })),
    On = Z((t, n, e) => It(kn(t, n))(e)),
    An = Z((t, n, e) => (e[t] = n), Nt(e)),
    Sn = Z((t, n, e) => It(An(t, n))(e)),
    xn = Qt('toggle'),
    Rn = (function() {
      const t =
